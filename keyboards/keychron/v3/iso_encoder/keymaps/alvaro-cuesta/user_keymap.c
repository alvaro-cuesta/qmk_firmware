...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [MAC_BASE] = LAYOUT_tkl_f13_iso(
        ...
        LT(MAC_FN1, KC_CAPS),             KC_A,     KC_S,     KC_D,     KC_F,     KC_G,     KC_H,     KC_J,     KC_K,     KC_L,      KC_SCLN,   KC_QUOT,      KC_NUHS,  KC_ENT,
        KC_LSFT,               KC_NUBS,   KC_Z,     KC_X,     KC_C,     KC_V,     KC_B,     KC_N,     KC_M,     KC_COMM,  KC_DOT,    KC_SLSH,                           KC_RSFT,              KC_UP,
        KC_LCTL,               KC_LOPTN,  KC_LCMMD,                               KC_SPC,                                 KC_RCMMD,  KC_ROPTN,  MO(MAC_FN2),            KC_RCTL,    KC_LEFT,  KC_DOWN,  KC_RGHT),

    [MAC_FN1] = LAYOUT_tkl_f13_iso(
        _______,                          _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,   _______,   _______,      _______,  _______,    _______,  _______,  KC_PWR,
    ...
    [MAC_FN2] = LAYOUT_tkl_f13_iso(
        QK_BOOTLOADER,                    KC_F1,    KC_F2,    KC_F3,    KC_F4,    KC_F5,    KC_F6,    KC_F7,    KC_F8,    KC_F9,     KC_F10,    KC_F11,       KC_F12,   RM_TOGG,    XXXXXXX,  XXXXXXX,  KC_PWR,
        XXXXXXX,                          RGBM_1,   RGBM_2,   RGBM_3,   RGBM_4,   RGBM_5,   RGBM_6,   RGBM_7,   RGBM_8,   RGBM_9,    RGBM_0,    RGBM_AP,      XXXXXXX,  XXXXXXX,    XXXXXXX,  XXXXXXX,  XXXXXXX,
        RM_TOGG,                          RGBM_Q,   RGBM_W,   RGBM_E,   RGBM_R,   RGBM_T,   RGBM_Y,   RGBM_U,   RGBM_I,   RGBM_O,    RGBM_P,    XXXXXXX,      XXXXXXX,              XXXXXXX,  XXXXXXX,  XXXXXXX,
        XXXXXXX,                          RGBM_A,   RGBM_S,   RGBM_D,   RGBM_F,   RGBM_G,   RGBM_H,   RGBM_J,   RGBM_K,   RGBM_L,    XXXXXXX,   XXXXXXX,      XXXXXXX,  XXXXXXX,
        XXXXXXX,               XXXXXXX,   RGBM_Z,   RGBM_X,   RGBM_C,   RGBM_V,   RGBM_B,   NK_TOGG,  RGBE_EF,  RGBE_HU,  RGBE_SA,   RGBE_SP,                           XXXXXXX,              XXXXXXX,
    ...
    [WIN_BASE] = LAYOUT_tkl_f13_iso(
        ...
        KC_GRV,                           KC_1,     KC_2,     KC_3,     KC_4,     KC_5,     KC_6,     KC_7,     KC_8,     KC_9,      KC_0,      KC_MINS,      KC_EQL,   KC_BSPC,    KC_INS,   KC_HOME,  KC_PGUP,
        KC_TAB,                           KC_Q,     KC_W,     KC_E,     KC_R,     KC_T,     KC_Y,     KC_U,     KC_I,     KC_O,      KC_P,      KC_LBRC,      KC_RBRC,              KC_DEL,   KC_END,   KC_PGDN,
        LT(WIN_FN1, KC_CAPS),             KC_A,     KC_S,     KC_D,     KC_F,     KC_G,     KC_H,     KC_J,     KC_K,     KC_L,      KC_SCLN,   KC_QUOT,      KC_NUHS,  KC_ENT,
        KC_LSFT,               KC_NUBS,   KC_Z,     KC_X,     KC_C,     KC_V,     KC_B,     KC_N,     KC_M,     KC_COMM,  KC_DOT,    KC_SLSH,                           KC_RSFT,              KC_UP,
        KC_LCTL,               KC_LWIN,   KC_LALT,                                KC_SPC,                                 KC_RALT,   KC_RWIN,   MO(WIN_FN2),            KC_RCTL,    KC_LEFT,  KC_DOWN,  KC_RGHT),
    ...
    [WIN_FN2] = LAYOUT_tkl_f13_iso(
        QK_BOOTLOADER,                    KC_BRID,  KC_BRIU,  KC_TASK,  KC_FLXP,  RM_VALD,  RM_VALU,  KC_MPRV,  KC_MPLY,  KC_MNXT,   KC_MUTE,   KC_VOLD,      KC_VOLU,  RM_TOGG,    XXXXXXX,  XXXXXXX,  KC_PWR,
        XXXXXXX,                          RGBM_1,   RGBM_2,   RGBM_3,   RGBM_4,   RGBM_5,   RGBM_6,   RGBM_7,   RGBM_8,   RGBM_9,    RGBM_0,    RGBM_AP,      XXXXXXX,  XXXXXXX,    XXXXXXX,  XXXXXXX,  XXXXXXX,
        RM_TOGG,                          RGBM_Q,   RGBM_W,   RGBM_E,   RGBM_R,   RGBM_T,   RGBM_Y,   RGBM_U,   RGBM_I,   RGBM_O,    RGBM_P,    XXXXXXX,      XXXXXXX,              XXXXXXX,  XXXXXXX,  XXXXXXX,
        XXXXXXX,                          RGBM_A,   RGBM_S,   RGBM_D,   RGBM_F,   RGBM_G,   RGBM_H,   RGBM_J,   RGBM_K,   RGBM_L,    XXXXXXX,   XXXXXXX,      XXXXXXX,  XXXXXXX,
        XXXXXXX,               XXXXXXX,   RGBM_Z,   RGBM_X,   RGBM_C,   RGBM_V,   RGBM_B,   NK_TOGG,  RGBE_EF,  RGBE_HU,  RGBE_SA,   RGBE_SP,                           XXXXXXX,              XXXXXXX,
        XXXXXXX,               KC_APP,    XXXXXXX,                                XXXXXXX,                                XXXXXXX,   KC_APP,    XXXXXXX,                XXXXXXX,    XXXXXXX,  XXXXXXX,  XXXXXXX),
};
