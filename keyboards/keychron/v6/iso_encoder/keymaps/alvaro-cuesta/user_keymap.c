...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [MAC_FN2] = LAYOUT_iso_110(
        XXXXXXX,                KC_F1,    KC_F2,    KC_F3,    KC_F4,    KC_F5,    KC_F6,    KC_F7,    KC_F8,    KC_F9,    KC_F10,   KC_F11,   KC_F12,      RGB_TOG,        XXXXXXX,  XXXXXXX,  KC_PWR,         XXXXXXX,  XXXXXXX,  XXXXXXX,  MC_0,
    ...
    [WIN_FN2] = LAYOUT_iso_110(
        XXXXXXX,                KC_BRID,  KC_BRIU,  KC_TASK,  KC_FLXP,  RGB_VAD,  RGB_VAI,  KC_MPRV,  KC_MPLY,  KC_MNXT,  KC_MUTE,  KC_VOLD,  KC_VOLU,     RGB_TOG,        XXXXXXX,  XXXXXXX,  KC_PWR,         XXXXXXX,  XXXXXXX,  XXXXXXX,  MC_0,
        XXXXXXX,                RGBM_1,   RGBM_2,   RGBM_3,   RGBM_4,   RGBM_5,   RGBM_6,   RGBM_7,   RGBM_8,   RGBM_9,   RGBM_0,   RGBM_AP,  XXXXXXX,     XXXXXXX,        XXXXXXX,  XXXXXXX,  XXXXXXX,        XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,
        RGB_TOG,                RGBM_Q,   RGBM_W,   RGBM_E,   RGBM_R,   RGBM_T,   RGBM_Y,   RGBM_U,   RGBM_I,   RGBM_O,   RGBM_P,   XXXXXXX,  XXXXXXX,                     XXXXXXX,  XXXXXXX,  XXXXXXX,        XXXXXXX,  XXXXXXX,  XXXXXXX,
        XXXXXXX,                RGBM_A,   RGBM_S,   RGBM_D,   RGBM_F,   RGBM_G,   RGBM_H,   RGBM_J,   RGBM_K,   RGBM_L,   XXXXXXX,  XXXXXXX,  XXXXXXX,     XXXXXXX,                                            XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,
        XXXXXXX,                XXXXXXX,  RGBM_Z,   RGBM_X,   RGBM_C,   RGBM_V,   RGBM_B,   NK_TOGG,  RGBE_EF,  RGBE_HU,  RGBE_SA,  RGBE_SP,               XXXXXXX,                  XXXXXXX,                  XXXXXXX,  XXXXXXX,  XXXXXXX,
